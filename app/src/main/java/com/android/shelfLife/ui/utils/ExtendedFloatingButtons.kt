 ...
 * expands to show the secondary FAB when clicked. The secondary FAB navigates to a specified screen.
 *
 ...
 * @param firstScreen The screen to navigate to when the secondary FAB is clicked. Defaults to Screen.GENERATE_RECIPE.
 * @param secondScreen The screen to navigate to when the primary FAB is clicked. Defaults to Screen.ADD_RECIPE.
