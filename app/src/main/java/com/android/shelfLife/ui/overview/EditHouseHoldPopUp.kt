...
@Composable
fun EditHouseHoldPopUp(showDialog: Boolean, onDismiss: () -> Unit,
    ...
    if (showDialog) {
        androidx.compose.material3.AlertDialog(
            ...
            confirmButton = {
                Button(
                    onClick = {
                        houseHoldsToDeleteId.forEach {
                            householdViewModel.deleteHouseholdById(it)
                        }
                        houseHolds.forEach(){
                            householdViewModel.updateHousehold(it)
                        }
                        onDismiss()
                    }
                ) {
