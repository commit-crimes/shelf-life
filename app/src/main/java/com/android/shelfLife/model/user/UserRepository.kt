...
interface UserRepository {
     ...
     * This can be called once at startup to load initial data.
     */
    ...
    /**
     * Stops listening for changes to the invitations field.
     * Call this when the listener is no longer needed to avoid memory leaks.
     */
