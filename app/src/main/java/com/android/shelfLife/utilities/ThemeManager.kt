...
/**
 * Manages dynamic theme switching for the leaderboard UI in the Shelf Life app.
 *
 * Provides predefined light and dark color schemes for two modes:
 * - Rat mode (yellow-themed)
 * - Stinky mode (green-themed)
 *
 * The active theme changes based on the selected mode and whether dark mode is enabled.
 */
object ThemeManager {

    /**
     * Light color scheme for Rat leaderboard mode.
     */
    ...
    /**
     * Dark color scheme for Rat leaderboard mode.
     */
    ...
    /**
     * Light color scheme for Stinky leaderboard mode.
     */
    ...
    /**
     * Dark color scheme for Stinky leaderboard mode.
     */
    ...
    // Current active leaderboard mode
    var activeMode: LeaderboardMode? = null

    // Current color scheme based on mode and theme
    var currentColorScheme: MutableState<ColorScheme?> = mutableStateOf(null)

    /**
     * Updates the color scheme based on the active leaderboard mode and dark mode preference.
     *
     * @param mode The active leaderboard mode (Rat or Stinky).
    ...
    /**
     * Resets the active mode and current color scheme to null.
     */
    fun resetMode() {
        activeMode = null
