 ...
 *
 * @return A Map representation of the `FoodFacts` object, including its name, barcode, quantity,
 * category, nutrition facts, and image URL.
 */
 ...
 *
 * @return A `FoodFacts` object constructed from the given Map.
 */
...
/**
 * Converts a `Quantity` object into a Map for Firestore storage.
 *
 * @return A Map representation of the `Quantity` object, including its amount and unit.
 */
 ...
 *
 * @return A `Quantity` object constructed from the given Map.
 */
...
/**
 * Converts a `NutritionFacts` object into a Map for Firestore storage.
 *
 * @return A Map representation of the `NutritionFacts` object, including all its nutritional
 * values.
 */
 ...
 *
 * @return A `NutritionFacts` object constructed from the given Map.
 */
