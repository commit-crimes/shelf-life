...
fun Map<String, Any?>.toFoodFacts(): FoodFacts {
    ...
    val category = categoryStr?.let { com.android.shelfLife.model.foodFacts.FoodCategory.valueOf(it) }
...
fun Map<String, Any?>.toQuantity(): Quantity {
    ...
    val unit = unitStr?.let { com.android.shelfLife.model.foodFacts.FoodUnit.valueOf(it) }
