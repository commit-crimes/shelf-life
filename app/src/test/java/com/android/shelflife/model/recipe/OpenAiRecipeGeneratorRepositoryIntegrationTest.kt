...
class OpenAiRecipeGeneratorRepositoryIntegrationTest {
  ...
  */
/**
 * Integration test for generating recipes using OpenAI API (this test queries the openai api). Set
 * RUN_INTEGRATION_TEST to true to run the test and print out results of a recipe. WARNING!!: DO NOT
 * PUSH TO CI WITH INTEGRATION TEST ENABLED. THIS TEST DOES NOT MOCK, IT PROPERLY CALLS THE API.
 * ONLY FOR DEBUGGING LOCALLY. (note: This test requires a valid OpenAI API key to run.)
 *//*
