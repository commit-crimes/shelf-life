...
import com.android.shelfLife.utils.toMap
...
class FoodItemRepositoryFirestoreTest {
    ...
    fun addFoodItemHandlesFirestoreErrorGracefully(): Unit = runBlocking {
        // Arrange
        val foodItem = FoodItem(uid = "item123", foodFacts = mock(FoodFacts::class.java), location = FoodStorageLocation.PANTRY, owner = "user1")
    ...
    @Test
    fun
            deleteFoodItemRemovesItemFromFirestore(): Unit = runBlocking {
        // Arrange
