...
class ChooseFoodItemScreenTest {
    ...
    private val foodFactsSuggestionsFlow = MutableStateFlow<List<FoodFacts>>(listOf(
        FoodFacts(name = "Apple", quantity = Quantity(1.0, FoodUnit.COUNT), imageUrl = "url1"),
        FoodFacts(name = "Banana", quantity = Quantity(2.0, FoodUnit.COUNT), imageUrl = "url2")
    ))
    ...
    fun testTitleDisplayed() {
        ...
        composeTestRule.setContent { ChooseFoodItem(navigationActions = navigationActions, foodItemViewModel) }

        composeTestRule.onNodeWithText("Choose Food Item Image")
            .assertExists()
            .assertIsDisplayed()
    }
    ...
    fun testSelectImageTextDisplayed() {
        ...
        composeTestRule.onNodeWithText("Select an Image:")
            .assertExists()
            .assertIsDisplayed()
    }
    ...
    fun testLazyGridDisplaysFoodItems() {
        ...
        composeTestRule.onAllNodesWithTag("foodImage", useUnmergedTree = true)
            .assertCountEquals(2)

        composeTestRule.onAllNodesWithTag("IndividualFoodItemImage", useUnmergedTree = true)
            .assertCountEquals(2)

        composeTestRule.onNodeWithTag("noImage", useUnmergedTree = true)
            .assertExists()
            .assertIsDisplayed()

        composeTestRule.onNodeWithTag("uploadImage", useUnmergedTree = true)
            .assertExists()
            .assertIsDisplayed()
    }
    ...
    fun testNoImageOptionDisplayed() {
        ...
        composeTestRule.onNodeWithTag("noImageText", useUnmergedTree = true)
            .assertExists()
            .assertIsDisplayed()
    ...
    fun testSubmitButtonSubmitsSelectedImage() {
        ...
        composeTestRule.onNodeWithTag("foodSave", useUnmergedTree = true)
            .assertExists()
            .assertIsEnabled()
