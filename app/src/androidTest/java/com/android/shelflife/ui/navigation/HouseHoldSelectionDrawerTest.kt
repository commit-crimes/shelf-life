...
class HouseHoldSelectionDrawerTest {
    ...
    fun displaysHouseholdsCorrectly() {
        val household1 = HouseHold(uid = "1", name = "Household One", members = emptyList(), foodItems = emptyList())
        val household2 = HouseHold(uid = "2", name = "Household Two", members = emptyList(), foodItems = emptyList())
        ...
        composeTestRule.onNodeWithTag("householdElement_0")
            .assertIsDisplayed()
            .assertTextContains("Household One")

        composeTestRule.onNodeWithTag("householdElement_1")
            .assertIsDisplayed()
