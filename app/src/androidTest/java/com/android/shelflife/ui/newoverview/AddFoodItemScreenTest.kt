...
class AddFoodItemScreenTest {
  ...
  fun testAmountFieldValidation() {
    ...
    // Verify error message is displayed
    composeTestRule
        .onNodeWithText(composeTestRule.activity.getString(R.string.amount_not_number_error))
        .assertIsDisplayed()
    ...
    composeTestRule
        .onNodeWithText(composeTestRule.activity.getString(R.string.amount_negative_error))
        .assertIsDisplayed()
  ...
  fun testDateFieldsValidation() {
    ...
    // Check error
    composeTestRule
        .onNodeWithText(composeTestRule.activity.getString(R.string.date_invalid_error))
        .assertIsDisplayed()
