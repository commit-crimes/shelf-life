...
class EditFoodItemScreenTest {
    ...
    fun testInitialUIComponentsDisplayed() {
        ...
        composeTestRule.onNodeWithTag("editFoodItemScreen")
    ...
    fun testDateFieldsValidation() {
        ...
        composeTestRule.onNodeWithTag("editFoodExpireDate").performTextClearance()
        composeTestRule.onNodeWithTag("editFoodExpireDate").performTextInput("31122030") // Valid future date
    ...
    fun testSubmitButtonWithValidForm() {
        ...
        composeTestRule.onNodeWithTag("editFoodBuyDate").performTextInput(
