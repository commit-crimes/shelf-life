...
class TopNavigationBarTest {
    ...
    fun setUp() {
        ...
        testNutritionFacts = NutritionFacts(
            energyKcal = 52,
            fat = 0.2,
            saturatedFat = 0.1,
            carbohydrates = 14.0,
    ...
    fun filterChipItem_toggleSelection() {
        ...
        composeTestRule.setContent {
            ...
            FilterChipItem(text = text, isSelected = isSelected.value, onClick = {
