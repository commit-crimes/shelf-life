...
class EditFoodItemScreenTest {
    ...
    private val initialFoodItem = FoodItem(
        uid = "1",
        foodFacts = com.android.shelfLife.model.foodFacts.FoodFacts(
            name = "Apple",
            barcode = "123456789",
            quantity = com.android.shelfLife.model.foodFacts.Quantity(1.0, FoodUnit.COUNT),
            category = FoodCategory.FRUIT,
            nutritionFacts = com.android.shelfLife.model.foodFacts.NutritionFacts(energyKcal = 52)
        ),
    ...
    fun testInitialUIComponentsDisplayed() {
        ...
        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("editFoodAmount"))
        composeTestRule.onNodeWithTag("editFoodAmount").assertIsDisplayed()

        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("editFoodUnit"))
        composeTestRule.onNodeWithTag("editFoodUnit").assertIsDisplayed()

        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("editFoodLocation"))
        composeTestRule.onNodeWithTag("editFoodLocation").assertIsDisplayed()

        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("editFoodExpireDate"))
        composeTestRule.onNodeWithTag("editFoodExpireDate").assertIsDisplayed()

        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("editFoodOpenDate"))
        composeTestRule.onNodeWithTag("editFoodOpenDate").assertIsDisplayed()

        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("editFoodBuyDate"))
        ...
        composeTestRule.onNodeWithTag("editFoodItemScreen").performScrollToNode(hasTestTag("cancelButton"))
    ...
    fun testSubmitButtonWithValidForm() {
        ...
        composeTestRule.onNodeWithTag("editFoodBuyDate").performTextInput(formatTimestampToDate(Timestamp.now()))
        ...
        runBlocking {
            verify(foodItemRepository).updateFoodItem(eq("household1"), any())
        }
